...
public class TeacherIssueActivity extends AppCompatActivity {
...
//  };
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.teacherissue);
    ...
    findViewById(R.id.button_submit_publish).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if ("".equals(mTitleEdit.getText().toString())) {
          Toast.makeText(TeacherIssueActivity.this, "请输入标题", Toast.LENGTH_SHORT).show();
          return;
        }
        if ("".equals(mDiscriptionEdit.getText().toString())) {
          Toast.makeText(TeacherIssueActivity.this, "请输入商品描述", Toast.LENGTH_SHORT).show();
          return;
        }

        if (mImageBytes == null) {
          Toast.makeText(TeacherIssueActivity.this, "请选择一张照片", Toast.LENGTH_SHORT).show();
          return;
        }
        ...
        product.saveInBackground(new SaveCallback() {
          ...
          public void done(AVException e) {
            if (e == null) {
              ...
              TeacherIssueActivity.this.finish();
            } else {
              mProgerss.setVisibility(View.GONE);
              Toast.makeText(TeacherIssueActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
          }
        });
