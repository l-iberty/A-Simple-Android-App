...
public class StudInfoManageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stud_info_manage);
        ...
        if (filePathsListView != null) {
            filePathsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    if (adapter != null) {
                        // 获取选中的 *.xls 文件路径, 解析后将家长、教师和学生的数据上传到云平台
                        String xlsFile = adapter.getItem(i);
                        ImportUtilities iu = new ImportUtilities(xlsFile);
                        iu.uploadParentUser(iu.getParentUsers());
                        iu.uploadTeacherUserInfo(iu.getTeacherUsers());
                        iu.uploadStudentInfo(iu.getStudents());
                    }
                }
            });
        }
        ...
        // "信息导入" 按钮
        Button importBtn = (Button) findViewById(R.id.button_import);
        if (importBtn != null) {
            importBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (filePathsListView != null) {
                        adapter = new ArrayAdapter<>(StudInfoManageActivity.this,
